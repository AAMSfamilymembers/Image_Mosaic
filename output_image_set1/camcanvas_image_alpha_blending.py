...
image4 = cv2.resize(cv2.imread('14.jpg', 1),(image1.shape[1],image1.shape[0]))
image5 = cv2.resize(cv2.imread('14.jpg', 1),(image1.shape[1],image1.shape[0]))
image6 = cv2.resize(cv2.imread('14.jpg', 1),(image1.shape[1],image1.shape[0]))
cv2.imwrite('image_check' + '.jpg',image4)
canvas1 = np.zeros([3*image1.shape[0],4*image1.shape[0],3],dtype ='uint8')
img_data.append(image1)
img_data.append(image2)
img_data.append(image3)
img_data.append(image4)
img_data.append(image5)
img_data.append(image6)
print(np.shape(img_data[1]))
print(np.shape(img_data[4]))
...
def stitch(image3,m):
	...
	canvas[ind_common] = canvas[ind_common]*0.2 + dst[ind_common]*0.8
...
cv2.imwrite('canvas_image_alpha_blending.jpg',canvas)
